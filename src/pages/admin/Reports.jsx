// src/pages/admin/QuestionManagement.jsx (Updated - No Static Data)
...
const QuestionManagement = () => {
  ...
  // Get dynamic subjects from existing questions only (NO STATIC DATA)
  ...
  const handleBulkImport = async () => {
    ...
    })).filter(q => q.text && q.subject && q.options.every(opt => opt));
            ...
            <div>
              ...
              {availableSubjects.length === 0 && (
                <p className="text-xs text-amber-600 mt-1">
                  No subjects available. Type a subject name to create one.
                </p>
              )}
            </div>
          </div>
          
          {/* Allow adding new subject dynamically */}
          {availableSubjects.length === 0 && (
            <Input
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <ul className="text-sm text-blue-800 list-disc list-inside mt-2">
              ...
              <li>subject - Subject category (creates new subjects automatically)</li>
            </ul>
          </div>
